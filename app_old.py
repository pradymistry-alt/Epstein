...
# Import your EXACT working script
# Make sure iamjiangingit_v4_FINAL.py is in the same folder
sys.path.insert(0, '.')
            ...
            const exportCSV = () => {
                ...
                const csv = [
                    ...
                    ...data.pickable.map(t => [
                        ...
                        (t.ML_Win_Prob*100).toFixed(0)+'%', t.Synergy_Score, t.Category
                    ].join(','))
                ].join('\\n');
                    ...
                    <div className="card">
                        ...
                        {tab === 'fraud' && data && (
                            <div>
                                ...
                                <p style={{fontSize:'14px',color:'#6b7280',marginBottom:'10px'}}>Top 8 rank but low ML probability - first round exit risk!</p>
                                {data.frauds.length > 0 ? (
                                    ...
                                    <div style={{textAlign:'center',padding:'40px'}}>
                                        ...
                                        <div style={{fontSize:'18px',fontWeight:500,color:'#059669'}}>No frauds detected!</div>
                                        <div style={{color:'#6b7280'}}>Top 8 teams all look solid</div>
                                    </div>
                                )}
                            </div>
                        )}
                            ...
                            <div>
                                ...
                                <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:'15px',marginTop:'20px'}}>
                                    ...
                                    <div style={{padding:'15px',background:'#d1fae5',borderRadius:'8px'}}>
                                        <div style={{fontSize:'12px',color:'#6b7280'}}>ML Top Picks (70%+)</div>
                                ...
                                {data.myTeamData && (
                                    <div style={{marginTop:'20px',padding:'15px',background:'linear-gradient(to right, #dbeafe, #e9d5ff)',borderRadius:'8px'}}>
                                        <h3 style={{marginBottom:'10px'}}>📍 Your Team: {myTeam}</h3>
                                        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(120px,1fr))',gap:'15px'}}>
                                            ...
                                            <div><div style={{fontSize:'12px',color:'#6b7280'}}>Quality Score</div><div style={{fontSize:'20px',fontWeight:'bold'}}>{data.myTeamData.Quality_Score}</div></div>
                                            ...
                                            <div><div style={{fontSize:'12px',color:'#6b7280'}}>Category</div><div style={{fontSize:'20px',fontWeight:'bold'}}>{data.myTeamData.Category}</div></div>
                                        </div>
                                    </div>
                                )}
                            </div>
...
def analyze():
    """Run your EXACT working Python script"""
    try:
        data = request.json
        ...
        df, my_stats = vex_module.analyze_event_ml(
            event_sku, 
            api_key, 
            season_id, 
            model_data, 
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("🚀 VEX Scout v4 Web Server (Using Your Exact Code)")
    print("="*60)
